...
const Navbar = () => {
    ...
    const navOptions = < >
        ...
        <li><NavLink className='font-bold text-base' to='/myPostedJobs'>My Post</NavLink></li>
        <li><NavLink className='font-bold text-base' to='/addJob'>Add  Job</NavLink></li>
        <li><NavLink className='font-bold text-base' to='/myApplications'>My Apply</NavLink></li>
